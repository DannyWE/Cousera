...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val myServerSubscription = myServer.start("/test")(headers => (
    ...
    val userInterrupted: Future[String] = Future.userInput("Enter something: ")
    .map(message => s"You entered ... $message")
    ...
    val terminationRequested: Future[String] = Future.firstCompletedOf(List(userInterrupted, timeOut))
